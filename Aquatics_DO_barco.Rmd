...
constants <- list(n = length(DO),
                  x_ic = 7,
                  sd_ic = 0.1,
                  sd_obs = 0.1) #mean(na.omit(daily_data$dissolvedOxygenExpUncert)),
                 # Tmin = Tmin)
                  #DO = DO)#,
                  #Kt = 1.2)#,
                  #kdo = 0.0014),
...
#                  x_ic = 8,
#                  sd_ic = 0.1, 
#                  sd_obs = mean(daily_data$dissolvedOxygenExpUncert),
#                  Tmin = Tmin_noNAs)
#
#data <- list(y = DO)
#nchain = 3
